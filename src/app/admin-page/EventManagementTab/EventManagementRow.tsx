...
export default function EventManagementRow({
    ...
    return <tr className={rowBackgroundColor}>
        ...
        <AdminPageTableCell><input defaultValue={event.name} onChange={(e) => setName(e.target.value)} /></AdminPageTableCell>
        <AdminPageTableCell><textarea defaultValue={event.description} onChange={(e) => setDescription(e.target.value)} /></AdminPageTableCell>
        <AdminPageTableCell>
            <input type="datetime-local" defaultValue={dateToDateTimeLocalString(currentStartDate)} onChange={(e) => setStart(new Date(e.target.value))}></input>
        </AdminPageTableCell>
        <AdminPageTableCell>
            <input type="datetime-local" defaultValue={dateToDateTimeLocalString(currentEndDate)} onChange={(e) => setEnd(new Date(e.target.value))}></input>
        </AdminPageTableCell>
