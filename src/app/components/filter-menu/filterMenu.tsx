...
const FilterMenu = ({ onFilterSubmit }: FilterMenuProps) => {
  ...
  const [closingSection, setClosingSection] = useState<
    "uploadDate" | "photographer" | "tags" | null
  >(null);
  ...
  const handleSectionToggle = (
    section: "uploadDate" | "photographer" | "tags",
  ) => {
    if (
      (section === "uploadDate" && showUploadDate) ||
          ...
          >
            ...
            <div>
              ...
              {showUploadDate && (
                <div
                  id="filter-container"
                  className={closingSection === "uploadDate" ? "closing" : ""}
                >
            ...
            <div>
              ...
              {showPhotographer && (
                <div
                  id="filter-container"
                  className={closingSection === "photographer" ? "closing" : ""}
                >
                  {authors.map((author) => (
                    <button
                      key={author.id}
            ...
            <div>
              ...
              {showTags && (
                <div
                  id="filter-container"
                  className={closingSection === "tags" ? "closing" : ""}
                >
                  {tags.map((tag) => (
                    <button
                      key={tag}
